...
| OpenTelemetry | OpenTelemetry instrumentation | Set OTel span attributes (refer to the [OpenTelemetry page](/langsmith/trace-with-opentelemetry#configure-for-the-messages-view)) |
