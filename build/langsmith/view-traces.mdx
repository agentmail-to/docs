...
<Note>
The Messages tab is disabled for threads that don't have any renderable messages. For traces from supported integrations, LangSmith defaults to the Messages view.
</Note>
